...
{\relsize{4}{\textbf{\textsc{\praktikumTitel}}}}\\[3ex]

%----Titel des Teilprojektes (\projektTitel in newComments verändern)---------
{\relsize{3}{\textbf{\textsc{\projektTitel}}}}\\[5ex]

Software-Entwicklungspraktikum (SEP)\\
Sommersemester 2011\\[4ex]

{\relsize{3}\so{\textbf{Pflichtenheft}}}\\[3ex]

%----eingebundenes Logo der TU--------------------------------------------------
\includegraphics[scale=0.8]{bilder/carolo.jpg}\\[2ex]
...
D-38092 Braunschweig\\[1.5ex]
Betreuer: Elmar Zander\\[1.5ex]

% ----Tabelle der Praktikumsteilnehmer------------------------------------------
Auftragnehmer:\\

\begin{tabular}{l<{\hspace{20mm}} l<{\hspace{30mm}}}\\  %10mm 30mm
