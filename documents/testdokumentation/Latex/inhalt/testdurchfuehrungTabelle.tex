\begin{longtable}{|0.3\linewidth|0.7\linewidth|}
Testfall & Zu testende Komponte / Funktion \\\hline

\textit{/T50/ Achterbahn visualisieren} & \textit{Achterbahn} \\\hline

\textit{/T100/ Konstruktion öffnen/schließen} & \textit{RollercoasterFrame} \\\hline
...
\textit{ /T530/ Grafikeinstellungen ändern} &  \textit{RollercoasterFrame}\\\hline

\textit{/T531/ Neuanordnung Interface} &  \textit{RollercoasterFrame} \\\hline

\textit{/T532/ HUD ein/abschalten} & \textit{HUD}\\\hline

\textit{/T533o/ Kameraperspektive ändern} &  \textit{Getestet wird die komplette Klasse CameraControl}\\\hline

\textit{/T1000/ Berechnung der Bézierkurve}  &  \textit{BezierCurve}\\\hline

\textit{ /T 1001/ Länge der Bézierkurve} &  \textit{getLength()}\\\hline

\textit{ /T 1002/ Punkt auf der Bézierkurve} &  \textit{getPoint(position)}\\\hline
...
\textit{ /T 1203/ Vektorlänge} &  \textit{length()}\\\hline

\textit{ /T 1204/ Längenquadrat} &  \textit{lengthSquared()}\\\hline
...
\textit{ /T 1210/ Fließkommakonvertierung} &  \textit{toF()}\\\hline
