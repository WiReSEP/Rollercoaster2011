...
Da es sich um ein System handelt, in dem eine ständige Berechnung (Loop) zur Laufzeit notwendig wird, einerseits durch die 3D-Anzeige, die eine ständige Aktualisierung erwartet und andererseits durch die Simulation an sich, ist es sinnig diesen Vorgang ebenfalls näher zu beleuchten.
...
\caption{Sequenzdiagramm für die Änderung der Kameraperspektive}
...
\caption{Sequenzdiagramm für die Warnung vor zu hoher Beschleunigung}
%\label{labelname}
\end{figure}
%Marco:
