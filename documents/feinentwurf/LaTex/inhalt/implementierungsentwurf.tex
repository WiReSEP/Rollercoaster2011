...
Der RollercoasterFrame unterteilt sich in 4 Bereiche. In dem Menü jmb gibt es Zugriff auf alle umgesetzten Funktionen in 4 Kategorien (Datei, Ansicht, Simulation und Hilfe). Im rightPanel sind die wichtigen Informationen angeordnet (Graph, Extrema, Log). Im bottomPanel sind Schnellzugriffsfunktionen für Öffnen von Konstruktionen, Starten und Stoppen von Simulation, Zeitrafferfunktionen und Ändern der Kameraperspektive angesiedelt. Die eigentliche Simulation wird im graphics-Canvas dargestellt.
