...
public class RollercoasterFrame extends JFrame {
  ...
  private JMenuBar jmb = new JMenuBar();
    private JMenu datei = new JMenu("Datei");
      private JMenuItem datei1 = new JMenuItem("Konstruktion �ffen");
      private JMenuItem datei2 = new JMenuItem("Konstruktion schlie�en");
  ...
  class MenuListener implements ActionListener, ItemListener {
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == datei1) { //Konstruktion laden
        ...
        JOptionPane.showMessageDialog(RollercoasterFrame.this, "Datei schlie�en.");
